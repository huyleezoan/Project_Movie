...
export default function Header(props) {
  return (
    <header className="z-10 p-4 bg-coolGray-100 text-coolGray-800 text-white fixed w-full" style={{ background:"rgb(243, 244, 246,0.5 )"}}>
      <div className="container flex justify-between h-16 mx-auto">
        ...
        >
          <svg
            ...
            fill="currentColor"
            viewBox="0 0 32 32"
            className="w-8 h-8 text-violet-900"
          >
